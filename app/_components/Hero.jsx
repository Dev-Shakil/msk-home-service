  ...
  return (
    <div className="flex items-center flex-col justify-center pt-14 pb-7 gap-3">
        <h2 className="font-bold text-[46px] text-center" >
            Find Home <span className="text-primary">Service/Repair</span><br></br> Near You 
        </h2>
        <h2 className="text-xl text-gray-600">Explore Best Home Service & Repair near you</h2>
